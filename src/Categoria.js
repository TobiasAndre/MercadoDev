...
class Categoria extends Component {
  ...
  loadAnuncios(urlCategoria){
    ...
    // carregar anuncios
    const url = `https://mercadodev-1ae9d.firebaseio.com/anuncios.json?orderBy=%22categoria%22&equalTo=%22${urlCategoria}%22`;
    axios
      .get(url)
      .then(data => {
  ...
  render(){
    return (
      <div>
        ...
        {
          Object.keys(this.state.anuncios).length === 0 && <p>Nenhum produto nesta seção</p>
        }
        <div className="row">
